...
class IncomingViewController: BaseViewController {
    ...
    var presenter: IncomingPresenterViewProtocol!
    ...
    override func configureView() {
        ...
        barTitle = "my_incoming_letters".localized
        ...
        collectionView.register(UINib(nibName: "LetterCell", bundle: nil), forCellWithReuseIdentifier: "letterCell1")
...
extension IncomingViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "letterCell1", for: indexPath)
        
        if let cell = cell as? LetterCell {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let letter = letters[indexPath.row]
        letter.incomingLetter = true
        
        let viewer = LetterViewer(letter: letter)
        viewer.listener = self
        
        LetterViewer.keyWindow?.addSubview(viewer)
    }
}

extension IncomingViewController: LetterViewerListener {
    
    func blockUser(userId: String) {
        
        showPopupYesNo(title: "attention".localized, message: "message_text.block_user".localized) { (type) in
            switch type {
            case .yes:
                self.presenter.blockUser(letterId: userId)
            default:
                break
            }
        }
    ...
    func reportUser(letterId: String) {
        ...
        showPopupYesNo(title: "attention".localized, message: "message_text.report_user".localized) { (type) in
            switch type {
            case .yes:
                self.presenter.reportUser(letterId: letterId)
            default:
                break
            }
        }
...
extension IncomingViewController: IncomingViewControllerProtocol {
    ...
    func notifyBlockSuccess() {
        showPopup(title: "success".localized, message: "message_text.successed_blocking".localized, completionHandler: nil)
    }
    
    func notifyReportSuccess() {
        showPopup(title: "success".localized, message: "message_text.successed_reporting".localized, completionHandler: nil)
    }
}
