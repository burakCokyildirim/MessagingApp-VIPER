//
//  FollowIncomingViewController.swift
//  Messaging App
//
...
class FollowIncomingViewController: BaseViewController {
    ...
    var presenter: FollowIncomingPresenterViewProtocol!
    ...
    override func configureView() {
        ...
        barTitle = "letters_expected".localized
        ...
        collectionView.register(UINib(nibName: "LetterCell3", bundle: nil), forCellWithReuseIdentifier: "letterCell3")
...
extension FollowIncomingViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "letterCell3", for: indexPath)
        
        if let cell = cell as? LetterCell3 {
...
extension FollowIncomingViewController: FollowIncomingViewControllerProtocol {
